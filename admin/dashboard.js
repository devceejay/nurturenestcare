...
function updateOverviewStats(stats) {
  document.getElementById('total-enrollments').querySelector('.card-stat-value').textContent = stats.totalEnrollments;
  document.getElementById('new-inquiries').querySelector('.card-stat-value').textContent = stats.newInquiries;
  document.getElementById('pending-messages').querySelector('.card-stat-value').textContent = stats.pendingMessages;
  document.getElementById('total-attendance').querySelector('.card-stat-value').textContent = stats.totalAttendance;
}
